...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($input) {
        ...
        echo json_encode(["message" => "Record added successfully", "data" => $data]);
    } else {
...
<head>
    ...
    <style>
        ...
        #addStudentSection, #studentListSection {
            margin-left: 1rem;
            margin-right: 1rem;
        }
...
<body>
    ...
    <div id="addStudentSection">
        <h3 class="text-success">Add a New Student</h3>
        ...
        $(document).ready(function () {
            ...
            function fetchStudents() {
                $.getJSON('data.json', function (data) {
                    ...
                    $("#studentList").html("<tr><td colspan='8' class='text-center text-danger'>No records found</td></tr>");
                });
            }
        });
    </script>
